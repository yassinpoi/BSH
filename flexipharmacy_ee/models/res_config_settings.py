...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            is_pos_agent_commission=param_obj.get_param('flexipharmacy_ee.is_pos_agent_commission'),
    ...
    def set_values(self):
        ...
        #Commission Part
        param_obj.set_param("flexipharmacy_ee.pos_commission_calculation", self.pos_commission_calculation)
        param_obj.set_param("flexipharmacy_ee.pos_commission_based_on", self.pos_commission_based_on)
        param_obj.set_param("flexipharmacy_ee.pos_commission_with", self.pos_commission_with)
        param_obj.set_param("flexipharmacy_ee.is_pos_agent_commission", self.is_pos_agent_commission)
