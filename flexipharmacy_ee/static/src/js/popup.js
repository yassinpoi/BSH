odoo.define('flexipharmacy_ee.popup', function (require) {
    "use strict";
...
//Order Summary Report
    ...
    var ReportPopupWidget = PopupWidget.extend({
        ...
        session_report_pdf: function(e){
            ...
            self.pos.chrome.do_action('flexipharmacy_ee.report_pos_inventory_session_pdf_front',{additional_context:{
        ...
        session_report_thermal: function(e){
            var self = this;
            var session_id = $(e.currentTarget).data('id');
            var report_name = "flexipharmacy_ee.front_inventory_session_thermal_report_template";
            var params = {
                model: 'ir.actions.report',
                method: 'get_html_report',
        ...
        location_report_pdf: function(e){
            ...
            self.pos.chrome.do_action('flexipharmacy_ee.report_pos_inventory_location_pdf_front',{additional_context:{
        ...
        location_report_thermal: function(e){
            var self = this;
            var location_id = $(e.currentTarget).data('id');
            var report_name = "flexipharmacy_ee.front_inventory_location_thermal_report_template";
            var params = {
                model: 'ir.actions.report',
                method: 'get_html_report',
...
//	        $('#orderdate-datepicker').focus();
            ...
            if (order.get_client()){
                var params = {
                    model: 'res.partner',
                    method: 'search_read',
                    domain: [['parent_id', '=', order.get_client().id], ['active','=',true]]
                }
    ...
    var ProductShopQtyPopupWidget = PopupWidget.extend({
        template: 'ProductShopQtyPopupWidget',
        show: function(options){
            options = options || {};
            this.prod_info_data = options.prod_info_data || '';
            this.total_qty = options.total_qty || '';
    ...
    gui.define_popup({name:'product_location_qty_popup', widget: ProductShopQtyPopupWidget});
});