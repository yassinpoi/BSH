odoo.define('flexipharmacy_ee.pos_dashboard', function (require) {
    "use strict";
            ...
            rpc.query({
                ...
                if(res){
                    ...
                    if(res['login_user_img']){
                        ...
                        self.$el.find('#image_viewer').html('<img class="rounded-circle" style="width:70px" src="/flexipharmacy_ee/static/src/img/icons/user.png">');
                    }
