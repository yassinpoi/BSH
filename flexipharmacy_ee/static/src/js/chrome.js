odoo.define('flexipharmacy_ee.chrome', function (require) {
"use strict";
...
//                });
            ...
            self.x_report = function(){
                ...
                self.pos.chrome.do_action('flexipharmacy_ee.pos_x_report',{additional_context:{
                ...
                if(self.pos.config.iface_print_via_proxy){
                    var pos_session_id = self.pos.pos_session.id;
                    var report_name = "flexipharmacy_ee.pos_x_thermal_report_template";
                    var params = {
...
//        	    $(this).find('i').toggleClass('fa fa-chevron-down fa fa-chevron-right');
                /*if($('#toggle_image').hasClass('right')){
                    ...
                    $('#toggle_image').attr('src','/flexipharmacy_ee/static/src/img/icons/angle-down.svg')
                }else{
                    $('#toggle_image').addClass('right');
                    $('#toggle_image').attr('src','/flexipharmacy_ee/static/src/img/icons/angle-right.png')
                }*/
            });
        },
    });
