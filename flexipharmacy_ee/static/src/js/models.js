odoo.define('flexipharmacy_ee.models', function (require) {
    "use strict";
    ...
    models.load_fields("res.users", ['image_small','login','company_ids','access_ereceipt','access_quick_cash_payment',
                                     ...
                                     'access_pos_graph','access_x_report','access_create_so_order',
                                     ...
                                     'based_on','can_give_discount','can_change_price', 'price_limit', 'discount_limit',
                                     'pos_user_type','sales_persons']);
    models.load_fields("res.partner", ['display_name','prefer_ereceipt',
                                       'remaining_credit_amount','property_account_receivable_id','parent_id',
                                       'birth_date','anniversary_date',
                                       'remaining_wallet_amount','credit_limit','is_doctor',
                                       'remaining_credit_limit','remaining_debit_amount','debit_limit','property_product_pricelist', 'active']);
    ...
    models.load_fields("account.journal", ['pos_journal_id','shortcut_key','jr_use_for','apply_charges','fees_amount','fees_type','optional', 'is_credit']);
...
//        	return [['from_date','<=',current_date],['to_date','>=',current_date],['active','=',true]];
    ...
    models.PosModel = models.PosModel.extend({
        ...
        load_new_partners: function(){
            ...
            var domain = [['customer','=',true],['active','=',true],['write_date','>',this.db.get_partner_write_date()]];
            rpc.query({
                    model: 'res.partner',
                    method: 'search_read',
                    args: [domain, fields],
